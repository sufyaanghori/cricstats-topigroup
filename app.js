(async function () {
  ...
  function renderAverage(data, container) {
    // Sort by average descending, only include players with at least 1 innings
    const sorted = [...data]
    ...
    container.innerHTML = `<table class="avg-table">
      <thead><tr><th>RNK</th><th>Player</th><th>Average</th><th>Innings</th><th>Runs</th></tr></thead>
      <tbody>${rows}</tbody></table>`;
  }
